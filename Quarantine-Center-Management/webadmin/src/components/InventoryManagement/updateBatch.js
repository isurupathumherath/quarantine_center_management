...
export default function UpdateBatch() {
    ...
    const updateAPIData = () => {
        axios.put(`http://localhost:8000/meds/update/${id}`, {
            itemcode,
            category,
            name,
            price_of_one,
    ...
    return (
        ...
        <div class="content container-fluid">
            <form> 
                    ...
                    <input placeholder='Price' value={price_of_one} onChange={(e) => parseInt(setprice(e.target.value))} readOnly/><br/><br/>
              
                    <label>Batch Number</label><br/>
                    <input placeholder='Batch Number' value={batchnum} onChange={(e) => setbatch(e.target.value)} readOnly/><br/><br/>
